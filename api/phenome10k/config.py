...
class Config(object):
    ...
    SECURITY_PASSWORD_SALT = os.environ.get(
        'SECURITY_PASSWORD_SALT', 'c27Lq82!b!a7yRC9ssPn'
    )
    ...
    SECURITY_EMAIL_SUBJECT_REGISTER = 'Welcome to Phenome10k!'
...
def get_celery_config():
    return dict(
        broker_url=Config.CELERY_BROKER_URL, result_backend=Config.CELERY_RESULT_BACKEND
    )
